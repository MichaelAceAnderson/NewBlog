	...
	<div class="panel">
		...
		<div class="panel-content">
			...
			<form method="POST" action="" enctype="multipart/form-data">
				<label for="fPostTitle">Titre du post:</label>
				<input type="text" autocomplete="off" name="fPostTitle" placeholder="Titre du post" required />
				<label for="fPostTags">Tags du post (séparés par des ;):</label>
				<input type="text" autocomplete="off" name="fPostTags" placeholder="Tags du post" required />
				<label for="fPostSummary">Résumé du post:</label>
				<textarea autocomplete="off" name="fPostSummary" placeholder="Résumé textuel de votre post"
					required></textarea>
