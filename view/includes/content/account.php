...
<div class="main">
    <?php
        if (isset($formError)) echo '<h1 class="notification error">' . $formError . '</h1>';
        if (isset($formSuccess)) echo '<h1 class="notification success">' . $formSuccess . '</h1>';
        ?>
    <!-- Changer de pseudo  -->
    <div class="panel">
        ...
        <div class="panel-content">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <input type="text" autocomplete="off" name="fUserName" placeholder="Nom d'utilisateur" />
                ...
                <input type="text" autocomplete="off" name="fNewUserNameConfirm"
                    placeholder="Confirmation de nom d'utilisateur" />
    ...
    <div class="panel">
        ...
        <div class="panel-content">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <input type="password" autocomplete="off" name="fPass" placeholder="Mot de passe" />
                <label for="fNewPass">Nouveau mot de passe:</label>
                <input type="password" autocomplete="off" name="fNewPass" placeholder="Nouveau mot de passe" />
    ...
    <div class="panel">
        ...
        <div class="panel-content">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                <textarea autocomplete="off" name="fPostContent" placeholder="Contenu textuel de votre post"></textarea>
